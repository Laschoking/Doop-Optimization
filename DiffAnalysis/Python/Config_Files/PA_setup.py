...
if __name__ == "__main__":
    ...
    ShellLib.create_input_facts(db_config, db_config.db1_dir_name, data_frame.db1_original_facts.path, gen_new_facts=gen_new_facts)
    ShellLib.create_input_facts(db_config, db_config.db2_dir_name, data_frame.db2_original_facts.path, gen_new_facts=gen_new_facts)
    ...
    pa_runtime.append(ShellLib.chase_nemo(program_config.sep_dl, data_frame.db1_original_facts.path, data_frame.db1_original_results.path))
    pa_runtime.append(ShellLib.chase_nemo(program_config.sep_dl, data_frame.db2_original_facts.path, data_frame.db2_original_results.path))
    ...
    for mapping in data_frame.mappings:
        ...
        pa_runtime.append(ShellLib.chase_nemo(program_config.merge_dl, mapping.db2_merged_facts.path, mapping.db2_nemo_merged_results.path))
