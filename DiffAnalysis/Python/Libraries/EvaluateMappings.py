...
def check_data_correctness(data_frame, mapping):
    ...
    diff = diff_two_dirs(data_frame.db2_original_facts, mapping.db2_merged_facts, rm_identifier='10', print_flag=True)
    ...
    diff = diff_two_dirs(data_frame.db2_original_results, mapping.db2_nemo_merged_results, rm_identifier='10', print_flag=True)
    if (diff[0] > 0 or diff[1] > 0):
    ...
    diff = diff_two_dirs(data_frame.db1_original_results, mapping.db1_inv_bij_results, rm_identifier='', print_flag=True)
    if (diff[0] > 0 or diff[1] > 0):
